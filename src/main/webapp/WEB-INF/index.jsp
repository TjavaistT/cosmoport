...
<head>
    ...
    <script href="${pageContext.request.contextPath}/resources/bootstrap-4.3.1-dist/js/jq.js" rel="stylesheet">
    </script>
    ...
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px; display: none" id="createButton">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3" style="padding: 0px 10px">
                ...
                <div class="form-row">
                        <input type="number" min="${shipLimits.prodYear.max}" class="form-control" id="inputProdYearNew">
                </div>
            </div>
            <div class="form-group col-md-3" style="padding: 0px 10px">
                <label>Crew size</label>
                <div class="form-row">
                        <input type="number" min="${shipLimits.crewSize.min}" class="form-control" id="inputCrewSizeNew">
                </div>
            </div>
            <div class="form-group col-md-3" style="padding: 0px 10px">
                <label>Max speed</label>
                <div class="form-row">
                        <input type="number" min="${shipLimits.speed.min}" max="${shipLimits.speed.max}" step="0.01" class="form-control" id="inputSpeedNew">
                </div>
            </div>
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3" style="padding: 0px 10px">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <input type="number"
                            class="form-control" id="inputProdYearAfter"
                            value="${shipLimits.prodYear.min}"
                            min="${shipLimits.prodYear.min}"
                            max="${shipLimits.prodYear.max}"
                        >
                    </div>
                    <div class="form-group col-md-6">
                        <input type="number"
                               class="form-control" id="inputProdYearBefore"
                               value = "${shipLimits.prodYear.max}"
                               min="${shipLimits.prodYear.min}"
                               max="${shipLimits.prodYear.max}"
                        >
                    </div>
            ...
            <div class="form-group col-md-3" style="padding: 0px 10px">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <input type="number"
                               class="form-control" id="inputCrewSizeMin"
                               value="${shipLimits.crewSize.min}"
                               min="${shipLimits.crewSize.min}"
                               max="${shipLimits.crewSize.max}"
                               >
                    </div>
                    <div class="form-group col-md-6">
                        <input type="number"
                               value="${shipLimits.crewSize.max}"
                               min="${shipLimits.crewSize.min}"
                               max="${shipLimits.crewSize.max}"
                               class="form-control" id="inputCrewSizeMax"
                        >
                    </div>
                </div>
            </div>
            <div class="form-group col-md-3" style="padding: 0px 10px">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <input type="number"
                               min="${shipLimits.speed.min}"
                               max="${shipLimits.speed.max}"
                               value="${shipLimits.speed.min}"
                               step="0.01" class="form-control" id="inputSpeedMin">
                    </div>
                    <div class="form-group col-md-6">
                        <input type="number"
                               min="${shipLimits.speed.min}"
                               max="${shipLimits.speed.max}"
                               value="${shipLimits.speed.max}"
                               step="0.01" class="form-control" id="inputSpeedMax">
                    </div>
                </div>
            </div>
            <div class="form-group col-md-3" style="padding: 0px 10px">
